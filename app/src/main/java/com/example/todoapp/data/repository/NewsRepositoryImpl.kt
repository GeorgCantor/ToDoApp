    ...
    fun getMockData(): List<NewsArticle> =
        listOf(
            ...
            NewsArticle(
                ...
                description =
                    "GAZA and LONDON -- The U.S.-backed Gaza Humanitarian Foundation (GHF) announced some changes at its Khan Younis aid distribution center on Monday, as Palestinians continue to report mass killings and chaos near aid distribution sites in the Gaza Strip.\n" +
                        "\n" +
